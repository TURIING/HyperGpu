...
void VulImage2D::TransitionImageLayout(VkImageLayout oldLayout, VkImageLayout newLayout, VkImageAspectFlags aspectFlags) const {
    ...
    m_pLogicDevice->WithSingleCmdBuffer([&](VulCommandBuffer* cmd) {
