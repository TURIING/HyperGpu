...
VulShader::VulShader(const std::shared_ptr<VulLogicDevice> &logicDevice, const ShaderInfo &shaderInfo): m_pLogicDevice(logicDevice) {
    m_pVertexShaderModule = std::make_unique<VulShaderModule>(logicDevice, shaderInfo.pSpvVertexCode, shaderInfo.spvVertexCodeSize);
    m_pFragShaderModule = std::make_unique<VulShaderModule>(logicDevice, shaderInfo.pSpvFragCode, shaderInfo.spvFragCodeSize);
    ...
    m_pDescriptorSetLayout = VulDescriptorSetLayout::Builder().AddDescriptorBindings(descriptorSetLayoutBindInfos).Build();
...
std::shared_ptr<VulPipeLineLayout> VulShader::GetPipelineLayout() const {
