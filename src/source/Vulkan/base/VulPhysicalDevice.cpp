...
#include "Vulkan/base/VulQueue.h"
#include "Vulkan/base/VulSwapChain.h"

VulPhysicalDevice::VulPhysicalDevice(const std::shared_ptr<VulInstance> &pInstance, const VulPhysicalDeviceCreateInfo &createInfo): m_pInstance(pInstance) {
